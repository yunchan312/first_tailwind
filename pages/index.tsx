      ...
      <div className="bg-white overflow-hidden rounded-2xl shadow-xl">
        ...
        <div className="rounded-3xl p-6 bg-white relative -top-5">
          <div className="flex relative -top-16 items-end justify-between">
            ...
            <div className="h-24 w-24 bg-indigo-400 rounded-full" />
            <div className="flex flex-col items-center">
              <span className="text-sm text-gray-500">Spent</span>
              <span className="font-semibold">$6340</span>
            </div>
          </div>
          <div className="relative flex flex-col items-center -mt-10 -mb-5">
            <span className="text-lg font-semibold">Kevin Jasmine</span>
            <span className="text-sm text-gray-500">Yong-In, South Korea</span>
          </div>
        </div>
      </div>
      <div className="bg-white p-10 rounded-2xl shadow-xl">
        ...
        <div className="flex flex-col">
          ...
          <span className="text-xs text-gray-500 mb-1.5">Chair</span>
          <div className="mt-3 mb-5 flex justify-between items-center">
            ...
            <div className="flex items-center space-x-4">
              <button className=" bg-blue-200 flex justify-center items-center aspect-square w-10 font-semibold text-gray-500 rounded-lg">
                -
              </button>
              <span>1</span>
              <button className=" bg-blue-200 flex justify-center items-center aspect-square w-10 font-semibold text-gray-500 rounded-lg">
          ...
          <div className="flex justify-between items-center">
            ...
            <button className="bg-blue-500 text-center text-sm text-white rounded-lg py-2 px-8">
              Add to cart
            </button>
          </div>
        </div>
